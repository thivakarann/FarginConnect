...
@Component({
  selector: 'app-smshistory-view',
  templateUrl: './smshistory-view.component.html',
  styleUrl: './smshistory-view.component.css'
})
export class SMSHistoryViewComponent {
  merchantid: any;
  ...
  smsResponse: any;
  constructor(private service: FarginServiceService, private toastr: ToastrService, private dialog: MatDialog,private router:Router,private ActivateRoute: ActivatedRoute,private location:Location) { }
  ...
  excelexportCustomer() {
    ...
    workbook.xlsx.writeBuffer().then((data: any) => {
      ...
      FileSaver.saveAs(blob, 'Sms-History-View.xlsx');
    });
  }
  View(id: any) {
  ...
  filterdate() {
    ...
    this.service.SmsHistoryMerchantFilter(this.merchantid,this.FromDateRange,this.ToDateRange).subscribe((res: any) => {
      if (res.flag == 1) {
