...
export class RegionComponent implements OnInit{
  ...
  dataSource:any;
  displayedColumns: string[] = ["serviceId","companyName","serviceProviderName","emailAddress","mobileNumber","location","Edit","status","createdBy","createdAt","modifiedBy","modifiedAt"]
  region:any;
  ...
  constructor(private dialog:MatDialog,private service:FarginServiceService,private toastr:ToastrService) {}
     ...
     this.service.RegionGet().subscribe((res: any) => {
      if(res.flag==1){
        ...
        for (let i = 0; i < this.region.length; i++) {
          const element = this.region[i];
          this.regionids = element.regionId;
    ...
    onSubmit(event: MatSlideToggleChange) {
