...
import { AddttionalManuvalPaymentComponent } from '../../Customer/addttional-manuval-payment/addttional-manuval-payment.component';
import { TransReturnDuesComponent } from '../trans-return-dues/trans-return-dues.component';
import { AddtransCommentsComponent } from '../addtrans-comments/addtrans-comments/addtrans-comments.component';
...
export class AdditionalTransactionsComponent {
  ...
  ngOnInit(): void {
    ...
    if (this.roleName == 'Merchant Super admin') {
      ...
      this.valueManualPayment = 'Additional Transactions-Manualpay';
      this.valueReverseDues = 'Additional Transactions-ReverseDues';
      this.valuecomments = 'Additional Transactions-comments';
      ...
      this.service.viewRole(this.roleId).subscribe((res: any) => {
        ...
        if (res.flag == 1) {
          ...
          for (let datas of this.getdashboard) {
            ...
            if (this.actions == 'Additional Transactions-Manualpay') {
              this.valueManualPayment = 'Additional Transactions-Manualpay'
            }
            if (this.actions == 'Additional Transactions-ReverseDues') {
              this.valueReverseDues = 'Additional Transactions-ReverseDues'
            }
            if (this.actions == 'Additional Transactions-comments') {
              this.valuecomments = 'Additional Transactions-comments'
            }
          }
        }
    ...
    this.service.Additionaltransexport(this.merchantId).subscribe((res: any) => {
      ...
      if (res.flag == 1) {
        ...
        this.transaction.forEach((element: any) => {
          ...
          this.response.push(element?.inventoryNameCreate?.inventoryName)
