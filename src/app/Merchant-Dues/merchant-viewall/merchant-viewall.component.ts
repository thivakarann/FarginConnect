...
export class MerchantViewallComponent {
  dataSource: any;
  displayedColumns: string[] = ["sno", "paymentId", "planname", "PlanType", "startDate", "endDate",       "createdDateTime",'amount',  'smsTotalAmount','sgstPercentage', 'cgstPercentage','igstPercentage',
