...
@Component({
  selector: 'app-cloud-other-payments-view',
  templateUrl: './cloud-other-payments-view.component.html',
  styleUrl: './cloud-other-payments-view.component.css'
})
export class CloudOtherPaymentsViewComponent implements OnInit {
  dataSource: any;
