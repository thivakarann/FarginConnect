...
@Component({
  selector: 'app-kycbranch-image',
  templateUrl: './kycbranch-image.component.html',
  styleUrl: './kycbranch-image.component.css'
})
export class KycbranchImageComponent {
 id: any;
  imageSrc: any;
  flag: any;
...
kycbranchimage!:FormGroup;
  ...
  ngOnInit(): void {
    ...
    this.service.getbranchkycImage(this.id, this.flag).subscribe({
      next: (res: any) => {
  ...
  getimageId(event: any) {
    ...
    if (files) {
        ...
        if (!allowedTypes.includes(fileType) || blockedExtensions.includes(fileExtension)) {
            this.toastr.error('File format not supported. Upload JPEG, PNG, or PDF');
  ...
  Update() {
    ...
    if (this.flag == 1) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchidentityFront(formData).subscribe((res: any) => {
        if (res.flag == 1) {
    ...
    if (this.flag == 2) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchidentityback(formData).subscribe((res: any) => {
        if (res.flag == 1) {
          this.updatedata = res.response;
          // this.toastr.success(res.responseMessage);
          this.dialog.closeAll();
    ...
    if (this.flag == 3) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchaddressFront(formData).subscribe((res: any) => {
        if (res.flag == 1) {
          this.updatedata = res.response;
          // this.toastr.success(res.responseMessage);
          this.dialog.closeAll();
    ...
    if (this.flag == 4) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchaddressback(formData).subscribe((res: any) => {
        if (res.flag == 1) {
          this.updatedata = res.response;
          // this.toastr.success(res.responseMessage);
          this.dialog.closeAll();
    ...
    if (this.flag == 5) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchsignFront(formData).subscribe((res: any) => {
        if (res.flag == 1) {
          this.updatedata = res.response;
          // this.toastr.success(res.responseMessage);
          this.dialog.closeAll();
    ...
    if (this.flag == 6) {
      ...
      formData.append('branchProofId', this.id);
      this.service.branchsignback(formData).subscribe((res: any) => {
        if (res.flag == 1) {
          this.updatedata = res.response;
          // this.toastr.success(res.responseMessage);
          this.dialog.closeAll();
