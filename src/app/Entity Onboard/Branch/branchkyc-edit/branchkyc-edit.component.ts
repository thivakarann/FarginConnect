...
export class BranchkycEditComponent {
  ...
  ngOnInit(): void {
    ...
    if (this.identityProofs) {
      ...
      this.KycIdentityForm.get('identityProofNo').setValue(
        this.identityProofNos
      );
    }
    if (this.addressProofvalue) {
      ...
      this.KycAddressForm.get('addressProofNo').setValue(
        this.addressProofNovalue
      );
    }
    if (this.signatureProofvalue) {
      this.KycsignatureForm.get('signatureProof').setValue(
        this.signatureProofvalue
      );
      this.onasignproof({ target: { value: this.signatureProofvalue } });

      // Manually set the signatureProofNo based on the existing data
      this.KycsignatureForm.get('signatureProofNo').setValue(
        this.signatureProofNovalue
      );
    }
  }
  ...
  onasignproof(event: any) {
    ...
    const signatureProofNoControl =
      this.KycsignatureForm.get('signatureProofNo');
  ...
  submit() {
    ...
    formData.append(
      'drivingLicenceDob',
      this.drivingLicenceDob.value || this.DrivingDob
    );
  ...
  submit1() {
    ...
    formData.append(
      'drivingLicenceDob',
      this.drivingLicenceDobs.value || this.DrivingDob
    );
  ...
  submit2() {
    ...
    formData.append(
      'drivingLicenceDob',
      this.drivingLicenceDobss.value || this.DrivingDob
    );
    formData.append(
      'passportDob',
      this.passportDobss.value || this.PassportDob
    );
