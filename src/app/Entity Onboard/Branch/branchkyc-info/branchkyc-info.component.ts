...
@Component({
  selector: 'app-branchkyc-info',
  templateUrl: './branchkyc-info.component.html',
  styleUrl: './branchkyc-info.component.css'
})
export class BranchkycInfoComponent {
  details: any;
  detaislone: any;
  approval1: any;
  bankdetails: any;
  ...
  ngOnInit(): void {
    ...
    this.service.branchkycinfo(this.ResponseId).subscribe((res: any) => {
      if (res.statusCode == 200) {
        this.kycres = res.response.response;
        this.jsonResponse = JSON.parse(this.kycres)
        this.fullName = this.jsonResponse.validated_data.full_name || this.jsonResponse.validated_data.name;
        ...
        this.verification = this.jsonResponse.validated_data.verification_message;
        ...
        console.log(this.inputvoterid);
        this.stcode = this.jsonResponse.validated_data.st_code;
        this.assemblyconstituencynumber = this.jsonResponse.validated_data.assembly_constituency_number;
        ...
        this.assemblyconstituency = this.jsonResponse.validated_data.assembly_constituency;
        this.area = this.jsonResponse.validated_data.area;
        this.parliamentaryname = this.jsonResponse.validated_data.parliamentary_name;
        this.multiple = this.jsonResponse.validated_data.multiple;
        this.parliamentaryconstituency = this.jsonResponse.validated_data.parliamentary_constituency;
        this.parliamentarynumber = this.jsonResponse.validated_data.parliamentary_number;
