...
import { entityterminaltransaction, OffilneTransaction } from '../../../fargin-model/fargin-model.module';
...
export class TerminalTransactionsComponent {
  ...
  ngOnInit(): void {
    ...
    this.service.EntityTerminalTransactions(submitModel).subscribe((res: any) => {
      if (res.flag == 1) {
