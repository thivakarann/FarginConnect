...
searchPerformed: boolean=false;
  ...
  ngOnInit(): void {
    ...
    if (this.roleName == 'Merchant Super admin') {
      this.valuecateadd = 'Category-Add';
     this.valuecateAction='Category-Edit';
     this.valuecateStatus='Category-Status'
      ...
      this.service.viewRole(this.roleId).subscribe((res: any) => {
        ...
        if (res.flag == 1) {
          ...
          for (let datas of this.getdashboard) {
            ...
            if (this.actions == 'Category-Add') {
              this.valuecateadd = 'Category-Add'
            }
           if(this.actions=='Category-Edit'){
            this.valuecateAction='Category-Edit'
           }
           if(this.actions=='Category-Status'){
            this.valuecateStatus='Category-Status'
           }
          }
        }
