...
import { AreaStatus, PincodeStatus } from '../../../fargin-model/fargin-model.module';
import { FarginServiceService } from '../../../service/fargin-service.service';
import { EditAreaComponent } from '../edit-area/edit-area.component';
import moment from 'moment';

@Component({
  selector: 'app-area-viewall',
  templateUrl: './area-viewall.component.html',
  styleUrl: './area-viewall.component.css'
})
export class AreaViewallComponent {
  dataSource: any;
  displayedColumns: string[] = ["sno", "pincode","area","status", "action",
    // 'view',
    // 'createdat',
    // 'createdby',
    // 'modifyat',
  ...
  ngOnInit(): void {
    this.service.AreaGetAll().subscribe((res: any) => {
  ...
  create(){
    this.dialog.open(CreateAreaComponent,{
      // data: { value: id },
      disableClose: true,
  ...
  ActiveStatus(event: MatSlideToggleChange, id: any) {
    ...
    this.service.AreaActiveStatus(id,submitModel).subscribe((res: any) => {
      if (res.flag == 1) {
