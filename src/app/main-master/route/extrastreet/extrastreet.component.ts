...
import { extraarearoute, extrastreetroute } from '../../../fargin-model/fargin-model.module';
import { FarginServiceService } from '../../../service/fargin-service.service';

@Component({
  selector: 'app-extrastreet',
  templateUrl: './extrastreet.component.html',
  styleUrl: './extrastreet.component.css'
})
export class ExtrastreetComponent {
  areaname: any[] = [];
  ...
  submit() {
    ...
    let submitModel: extrastreetroute = {
    ...
    this.service.extrastreetroutecreate(submitModel).subscribe((res: any) => {
