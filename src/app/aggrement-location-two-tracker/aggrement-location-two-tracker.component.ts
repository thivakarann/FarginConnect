...
import { AgreementConsent, AgreementlocationTracker, getiplocation } from '../fargin-model/fargin-model.module';
...
@Component({
  selector: 'app-aggrement-location-two-tracker',
  templateUrl: './aggrement-location-two-tracker.component.html',
  styleUrl: './aggrement-location-two-tracker.component.css'
})
export class AggrementLocationTwoTrackerComponent {
  RefferenceCode: any;
  Flag: any;
  Consent: any;
  details: any;
  ...
  ResendOTP() {
    this.Service.AgreementSendOtp(this.RefferenceCode, 1).subscribe((res: any) => {
    })
  }
  ...
  //     regionCode:this.LocationRegionCode,
