...
@Component({
  selector: 'app-branch-transaction-view',
  templateUrl: './branch-transaction-view.component.html',
  styleUrl: './branch-transaction-view.component.css'
})
export class BranchTransactionViewComponent implements OnInit{
