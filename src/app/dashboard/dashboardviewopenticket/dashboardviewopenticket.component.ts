...
@Component({
  selector: 'app-dashboardviewopenticket',
  templateUrl: './dashboardviewopenticket.component.html',
  styleUrl: './dashboardviewopenticket.component.css'
})
export class DashboardviewopenticketComponent {
 strings = "@";
  dataSource: any;
...
searchPerformed: boolean=false;
  ...
  ngOnInit(): void {
    ...
    this.service.dashboardticketstatus(this.merchantId, 'Open').subscribe((res: any) => {
  if(res.flag==1)
  {
  ...
  excelexportCustomer() {
    ...
    let worksheet = workbook.addWorksheet('Ticket Open Status');
    // Blank Row
    ...
    workbook.xlsx.writeBuffer().then((data: any) => {
      ...
      FileSaver.saveAs(blob, 'Ticket Open Status.xlsx');
    });
  }
