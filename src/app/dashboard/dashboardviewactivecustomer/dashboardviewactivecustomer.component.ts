...
@Component({
  selector: 'app-dashboardviewactivecustomer',
  templateUrl: './dashboardviewactivecustomer.component.html',
  styleUrl: './dashboardviewactivecustomer.component.css'
})
export class DashboardviewactivecustomerComponent {
  dataSource: any;
...
searchPerformed: boolean=false;
  ...
  ngOnInit() {
    this.service.dashboardviewactivecustomers(this.merchantId, 1).subscribe((res: any) => {
if(res.flag==1)
{
  ...
  excelexportCustomer() {
    ...
    workbook.xlsx.writeBuffer().then((data: any) => {
      ...
      FileSaver.saveAs(blob, 'Active Employee.xlsx');
    });
  }
