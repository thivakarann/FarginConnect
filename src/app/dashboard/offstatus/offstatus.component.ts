...
@Component({
  selector: 'app-offstatus',
  templateUrl: './offstatus.component.html',
  styleUrl: './offstatus.component.css'
})
export class OffstatusComponent {
dataSource: any;
...
searchPerformed: boolean=false;
  ...
  ngOnInit(): void {
    this.service.dashbaordonoffstatu(this.merchantId,'OFF').subscribe((res: any) => {
      if(res.flag==1)
      {
...
excelexportCustomer() {
  ...
  let worksheet = workbook.addWorksheet('Today OFF Status');
  // Blank Row
  worksheet.addRow([]);
  ...
  workbook.xlsx.writeBuffer().then((data: any) => {
    ...
    FileSaver.saveAs(blob, 'Today OFF Status.xlsx');
  });
}
