...
@Component({
  selector: 'app-dashboardviewholdticket',
  templateUrl: './dashboardviewholdticket.component.html',
  styleUrl: './dashboardviewholdticket.component.css'
})
export class DashboardviewholdticketComponent {
 strings = "@";
  dataSource: any;
...
searchPerformed: boolean=false;
  ...
  ngOnInit(): void {
    ...
    this.service.dashboardticketstatus(this.merchantId, 'Hold').subscribe((res: any) => {
  if(res.flag==1)
  {
  ...
  excelexportCustomer() {
    ...
    let worksheet = workbook.addWorksheet('Ticket Hold Status');
    // Blank Row
    ...
    workbook.xlsx.writeBuffer().then((data: any) => {
      ...
      FileSaver.saveAs(blob, 'Ticket Hold Status.xlsx');
    });
  }
