...
export class DashboardcontentComponent {
  ...
  additionalmonth: any;
  selectedactiveinactive: string = 'activemonth';
  activeinactive: any;
  valuecustomerstatus: any;
  valueCollectionAnalytics: any;
  isLoading = true;
  constructor(private languageService: LanguageService, public loaderService: LoaderService, private router: Router, private service: FarginServiceService, private cdRef: ChangeDetectorRef) { }
  ngOnInit(): void {

    this.loaderService.setExcludeLoader(true);

  
    this.currentLanguageSubscription = this.languageService.language.subscribe(lang => {
    ...
    this.service.dashboardthismonthstatustransactions(this.merchantId).subscribe((res: any) => {
      this.activeinactive = res.response;
    });
    ...
    // this.service.announcementView(this.bussinessId).pipe(
    //   concatMap((res1: any) => {
    //     this.announcement = res1.response;
    //     this.isLoading = false;
    //     return this.service.dashboardcount(this.merchantId);
        
    //   }),
    //   concatMap((res2: any) => {
    //     this.customercount = res2.response;
    //     this.isLoading = false;
    //     return this.service.ViewCustomerByMerchantDetail(this.merchantId);
    //   }),
    //   concatMap((res3: any) => {
    //     this.customerdetails = res3.response;
    //     this.isLoading = false;
    //     return this.service.dashbaordcustomerdayTransaction(this.merchantId);
    //   }),
    //   concatMap((res4: any) => {
    //     this.customertotal = res4.response;
    //     this.isLoading = false;
    //     return this.service.dashboardcustomersevenday(this.merchantId);
    //   }),
    //   concatMap((res5: any) => {
    //     this.sevenss = res5.response;
    //     this.isLoading = false;
    //     return this.service.dashboardcustomersevenday(this.merchantId);
    //   }),
    //   concatMap((res6: any) => {
    //     this.customersevenday = res6.response.method;
    //     this.isLoading = false;
    //     return this.service.dashboardthismonthcustomertransactions(this.merchantId);
    //   }),
    //   concatMap((res7: any) => {
    //     this.lastmonth = res7.response;
    //     this.isLoading = false;
    //     return this.service.dashboardthismonthadditionaltransactions(this.merchantId);
    //   }),
    //   concatMap((res8: any) => {
    //     this.additionalmonth = res8.response;
    //     this.isLoading = false;
    //     return this.service.dashboardthismonthstatustransactions(this.merchantId);
    //   }),
    //   concatMap((res9: any) => {
    //     this.activeinactive = res9.response;
    //     this.isLoading = false;
    //     return this.service.dashboardviewpendings(this.merchantId);
    //   }),
    //   concatMap((res10: any) => {
    //     this.duepending = res10.response;
    //     this.isLoading = false;
    //     return this.service.dashboardemployeecounts(this.merchantId);
    //   }),
    //   concatMap((res11: any) => {
    //     this.dashboardemployecount= res11.response;
    //     this.isLoading = false;
    //     return this.service.dashboardsetupboxallcotes(this.merchantId);
    //   }),
      
    //   concatMap((res12: any) => {
    //     this.dashboardallcotes = res12.response;
    //     this.isLoading = false;
    //     return this.service.dashboardcustomersevenamounts(this.merchantId);
    //   }),
    //   concatMap((res13: any) => {
    //     if (res13.flag == 1 || res13.flag == 2) {
    //       this.createseven(res13.response);
    //       this.isLoading = false;
    //     }
    //     return this.service.dashboardcustomersevenamounts(this.merchantId); // Adding the missing API call
    //   }),
    //   concatMap((res14: any) => {
    //     if (res14.flag == 1 || res14.flag == 2) {
    //       this.createseven(res14.response);
    //       this.isLoading = false;
    //     }
    //     return this.service.dashboardcustomeroveralls(this.merchantId);
    //   }),
    //   concatMap((res15: any) => {
    //     if (res15.flag == 1 || res15.flag == 2) {
    //       this.createMixedChart(res15.response);
    //       this.isLoading = false;
    //     }
    //     return this.service.ViewAdminforcollections(this.merchantId);
    //   }),
    //   concatMap((res16: any) => {
    //     this.viewemployee = res16.response;
    //     this.isLoading = false;
    //     return this.service.dashbaordtodayonoffcounts(this.merchantId);
    //   }),
    //   concatMap((res17: any) => {
    //     this.ontoday = res17.response;
    //     this.isLoading = false;
    //     this.initializeEmptyChart();
    //     return this.service.BranchView(this.merchantId);
    //   })
    // ).subscribe((res18: any) => {
    //   if (res18.flag == 1) {
    //     this.branchviews = res18.response;
    //     this.isLoading = false;
    //     this.branchstatus = true;
    //   } else if (res18.flag == 2) {
    //     this.branchstatus = false;
    //   }
    ...
    if (this.roleName == 'Merchant Super admin') {
      ...
      this.valuecustomerstatus = 'Dashboard-customer Active Inactive'
      this.valueCollectionAnalytics = 'Dashboard-Additional Collection Analytics'
      ...
      this.service.viewRole(this.roleId).subscribe((res: any) => {
        ...
        if (res.flag == 1) {
          ...
          for (let datas of this.getdashboard) {
            ...
            if (this.actions == 'Dashboard-customer Active Inactive') {
              this.valuecustomerstatus = 'Dashboard-customer Active Inactive'
            }
            if (this.actions == 'Dashboard-Additional Collection Analytics') {
              this.valueCollectionAnalytics = 'Dashboard-Additional Collection Analytics'
            }
          }
  ...
  getactiveinactivecustomer(event: any) {
    this.selectedactiveinactive = event;
    if (event == 'activelast') {
      this.service.dashboardlastmonthstatustransactions(this.merchantId).subscribe((res: any) => {
        this.activeinactive = res.response;
      });

    }

    if (event == 'activemonth') {
      this.service.dashboardthismonthstatustransactions(this.merchantId).subscribe((res: any) => {
        this.activeinactive = res.response;
      })
