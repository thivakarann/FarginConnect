...
@Component({
  selector: 'app-customersetupboxhistory',
  templateUrl: './customersetupboxhistory.component.html',
  styleUrl: './customersetupboxhistory.component.css',
})
export class CustomersetupboxhistoryComponent {
...
searchPerformed: boolean=false;
  ...
  ngOnInit(): void {
    ...
    this.service.customersetupboxhistory(this.merchantid,this.id).subscribe((res: any) => {
      if (res.flag == 1) {
        this.setupboxhistory = res.response;
        this.setupboxhistory.reverse();
