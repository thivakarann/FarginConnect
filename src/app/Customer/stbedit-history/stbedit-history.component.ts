...
@Component({
  selector: 'app-stbedit-history',
  templateUrl: './stbedit-history.component.html',
  styleUrl: './stbedit-history.component.css'
})
export class STBEditHistoryComponent {
  dataSource: any;
  displayedColumns: string[] = ["customerStbHistoryId", "stbNumber","serviceProviderName","doorNumber", "areaName", "streetName" , "createdBy", "createdDateTime"]
  ...
  ngOnInit(): void {
    ...
    this.service.STBCustomerHistory(this.STBId).subscribe((res: any) => {
      if (res.flag == 1) {
  ...
  exportexcel() {
   ...
   excelexportCustomer() {
      ...
      workbook.xlsx.writeBuffer().then((data: any) => {
        ...
        FileSaver.saveAs(blob, 'STB Customers Edit Log.xlsx');
