    ...
    this.service.customersetupboxbulkbyId(uploadId).subscribe((res: any) => {
      ...
      if (res.flag == 1) {
        ...
        this.responseData?.forEach((element: any) => {
          ...
          this.dataPush.push(sno);
          this.dataPush.push(element?.mobileNumber);
          this.dataPush.push(element?.billingDate);
        //  if (element.billingDate) {
        //            this.dataPush.push(moment(element?.billingDate).format('DD/MM/yyyy').toString());
        //          }
        //   else {
        //            this.dataPush.push('');
        ...
        //    }
          ...
          const alcotSuccessString = element?.['alcotChannelNames']?.join(', ') || '';
          const bouquetSuccessString = element?.['bouquetNames']?.join(', ') || '';
          const lcopSuccessString = element?.['lcopPlanNames']?.join(', ') || '';
