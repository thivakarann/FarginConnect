...
roleId: any = this.cryptoService.decrypt(sessionStorage.getItem('Nine') || '');
  ...
  getAdditional() {
    this.service.additionalRefundGetAll(this.pageSize, this.pageIndex).subscribe((res: any) => {
      if (res.flag == 1) {
  ...
  refundsearch(filterValue: string) {
    ...
    this.service.RefundGetAllSearch(filterValue, this.pageSize, this.pageIndex, 1).subscribe({
      next: (res: any) => {
        if (res.response) {
          this.refund = res.response;
          this.totalPages = res.pagination.totalElements;
  ...
  refundsearchadditional(filterValue: string) {
    ...
    this.service.RefundGetAllSearch(filterValue, this.pageSize, this.pageIndex, 2).subscribe({
      next: (res: any) => {
        if (res.response) {
          ...
          this.totalpage = res.pagination.pageSize;
          this.currentpage = res.pagination.currentPage;
          this.dataSources = new MatTableDataSource(this.additionalsearchdetails);
          this.currentfilvalShow = true;
        } else if (res.flag == 2) {
  ...
  filterdate() {
    this.service.RefundGetAllDateFilter(this.fromdatedue?.value, this.todatedue?.value, this.pageSize, this.pageIndex, 1).subscribe((res: any) => {
      if (res.flag == 1) {
  ...
  filterdateadditional() {
    this.service.RefundGetAllDateFilter(this.fromdateadditional?.value, this.todateadditional?.value, this.pageSize, this.pageIndex, 2).subscribe((res: any) => {
      if (res.flag == 1) {
  ...
  getData(event: any) {
    if (this.filterAction == 1) {
      this.service.RefundGetAllDateFilter(this.fromdatedue?.value || this.tempfrom, this.todatedue?.value || this.temptodate,
      ...
      this.service.RefundGetAllSearch(this.currentfilval, event.pageSize, event.pageIndex, 1).subscribe({
        next: (res: any) => {
          if (res.response) {
            this.refund = res.response;
            this.totalPages = res.pagination.totalElements;
  ...
  getDataAdditional(event: any) {
    if (this.filterActions == 1) {
      this.service.RefundGetAllDateFilter(this.fromdateadditional?.value || this.tempaddfrom, this.todateadditional?.value || this.tempaddtodate, event.pageSize, event.pageIndex, 2)
        .subscribe((res: any) => {
          if (res.flag == 1) {
            this.datetransaction = res.response;
            this.totalPages = res.pagination.totalElements;
      ...
      this.service.RefundGetAllSearch(this.currentfilvals, event.pageSize, event.pageIndex, 2).subscribe({
        next: (res: any) => {
          if (res.response) {
            this.additionalsearchdetails = res.response;
            this.totalPages = res.pagination.totalElements;
      ...
      this.service.additionalRefundGetAll(event.pageSize, event.pageIndex).subscribe((res: any) => {
        if (res.flag == 1) {
          this.additionaldetails = res.response;
          this.totalPages = res.pagination.totalElements;
          this.totalpage = res.pagination.pageSize;
